...
input = document.getElementById("Animation_contenuImage_file");

input.accept = "image/png, image/jpeg"

formulaire = document.querySelector('form[id="new-Animation-form"]');




input.addEventListener("change",(event)=>{
    const image = document.getElementById("Animation_contenuImage_file").files[0];
