...
// [STAMP] dc85123f5b6df3898631302216209f6e
...
trait ApiTesterActions
{
     ...
     */
    public function dontSeeOrphanEvent(object|array|string|null $expected = null): void
    {
     ...
     * @see \Codeception\Module\Symfony::dontSeeOrphanEvent()
     */
    public function cantSeeOrphanEvent(object|array|string|null $expected = null): void
    {
     ...
     */
    public function seeOrphanEvent(object|array|string $expected): void
    {
     ...
     * @see \Codeception\Module\Symfony::seeOrphanEvent()
     */
    public function canSeeOrphanEvent(object|array|string $expected): void
    {
     ...
     *
     * @see \App\Tests\Support\Module\ApiPlatform::sendPatch()
     */
     ...
     * Override to send HTTP headers.
     *
     * @see \App\Tests\Support\Module\ApiPlatform::sendPost()
     */
     ...
     * Override to send HTTP headers.
     *
     * @see \App\Tests\Support\Module\ApiPlatform::sendPut()
     */
     ...
     *
     * @see \App\Tests\Support\Module\ApiPlatform::seeResponseIsAnEntity()
     */
    public function seeResponseIsAnEntity(string $className, string $entityPath)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeResponseIsAnEntity', func_get_args()));
    }
     ...
     * @see \App\Tests\Support\Module\ApiPlatform::seeResponseIsAnEntity()
     */
    public function canSeeResponseIsAnEntity(string $className, string $entityPath)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeResponseIsAnEntity', func_get_args()));
    }
     ...
     * Assert that the JSON response is an entity.
     *
     * @see \App\Tests\Support\Module\ApiPlatform::seeResponseIsAnItem()
     */
    public function seeResponseIsAnItem(array $propertiesTypes, array $values = []): void
    {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeResponseIsAnItem', func_get_args()));
    }
     ...
     * @see \App\Tests\Support\Module\ApiPlatform::seeResponseIsAnItem()
     */
    public function canSeeResponseIsAnItem(array $propertiesTypes, array $values = []): void
    {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeResponseIsAnItem', func_get_args()));
    }
     ...
     *
     * @see \App\Tests\Support\Module\ApiPlatform::seeResponseIsACollection()
     */
    public function seeResponseIsACollection(string $className, string $collectionPath, array $propertiesTypes = []): void
    {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeResponseIsACollection', func_get_args()));
    }
     ...
     * @see \App\Tests\Support\Module\ApiPlatform::seeResponseIsACollection()
     */
    public function canSeeResponseIsACollection(string $className, string $collectionPath, array $propertiesTypes = []): void
    {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeResponseIsACollection', func_get_args()));
    }
     ...
     * Grab JSON response.
     *
     * @see \App\Tests\Support\Module\ApiPlatform::grabJsonResponse()
     */
    public function grabJsonResponse(): array
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabJsonResponse', func_get_args()));
    }
     ...
     *
     * @see https://tools.ietf.org/html/rfc2068#section-19.6.2.4
     *
